...
$item_id        = $_POST["requested_repo"];
$email          = $_POST["email"];
$username       = $_POST["username"];


set_form_data($email, $username, $purchase_code, $item_id);

validate_data($email, $username, $purchase_code, $item_id);
...
$res_get_gitlab_project_id = req_get_gitlab_project_id($item_id);
...
// Save record in db
$res_save_record_in_db = req_save_record_in_db($email, $username, $purchase_code, $item_id);
